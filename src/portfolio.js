...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Backend Web Developer 🚀 having an experience of building Web applications with Nodejs / PHP / .NET / Angular / Javasript and some other cool libraries and frameworks."
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    emoji("⚡ Develop strong Backend Web Applications"),
    emoji("⚡ Learn different Tech Stacks"),
    emoji("⚡ Explore different third party services like AWS, Postman, etc.")
  ],
